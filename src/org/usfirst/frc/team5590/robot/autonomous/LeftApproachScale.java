...
import org.usfirst.frc.team5590.robot.autonomous.commands.Output;
...
public class LeftApproachScale extends AutoStrategy {
	...
	private final static double CLIMB_HEIGHT = 72;
	...
	private void leftSideScale() {
		...
		addSequential(new LiftToHeight(CLIMB_HEIGHT));
		addSequential(new PolarDrive(80, 0, slowSpeed));
		addSequential(new Output(1));
	}
